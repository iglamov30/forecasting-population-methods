...
| File | What it is |
|---|---|
| `charlotte_5y.py` | The current version — ETS/ARIMA backtest + 5-year forecast, with confidence intervals. `florida/` and `citywide_forecast/` both import it from here. |
